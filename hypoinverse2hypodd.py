...
if __name__ == '__main__':
    ...
    rms_threshold=10 # in sec, events with rms larger than this will not be used
    gap_threshold=330 # in deg., events with station gap larger than this will not be used
    pick_nres=4       # if pick's residual larger than nres times event's rms
                        # the pick will not be used
    maxdep=35 # in km, events with larger depth will not be used (< dep in the timetable)
    maxdep_err=10 # in km, events with larger depth uncertainty will not be used
    maxdis_err=10 # in km, events with larger horizontal uncertainty will not be used
