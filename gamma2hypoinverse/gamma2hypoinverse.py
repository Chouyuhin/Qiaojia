...
# %%
picks = pd.read_csv('D:\MyRepository\Qiaojia\AssResults_2212raw_phasenet\gamma_picks_v3.csv', sep="\t")
events = pd.read_csv('D:\MyRepository\Qiaojia\AssResults_2212raw_phasenet\gamma_catalog.csv', sep="\t")
