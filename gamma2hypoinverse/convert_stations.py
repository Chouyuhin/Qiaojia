...
for i in tqdm(range(len(stations))):
    ...
    network_code, station_code,comp_code, channel_code= stations.iloc[i]['station_id'][:2],stations.iloc[i]['station_id'][2:],'','99' # QJ,01
    station_weight = " "
    ...
    line_hypoinverse = f"{station_code:<5} {network_code:<2} {comp_code:<1}{channel_code:<3} {station_weight}{abs(lat_degree):2.0f} {abs(lat_minute):7.4f}{north}{abs(lng_degree):3.0f} {abs(lng_minute):7.4f}{west}{elevation:4.0f}\n"
